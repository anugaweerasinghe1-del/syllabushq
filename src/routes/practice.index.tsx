  ...
  head: () => ({
    meta: [
      { title: "Choose your exam mode — SyllabusHQ" },
      {
        name: "description",
        content:
          "MCQs, structured papers, short-answer drills, or a full timed exam simulation. Pick a mode and begin.",
      },
      ...
      <main className="mx-auto max-w-5xl px-4 py-12 sm:px-6 sm:py-16">
        <div className="mb-10 rise">
          ...
          <p className="mt-3 max-w-xl text-sm text-muted-foreground sm:text-base">
            Each mode is its own dedicated experience — no tabs, no clutter. Pick what you want to
            train today.
          </p>
        </div>
