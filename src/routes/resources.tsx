  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "O/L Resources — SyllabusHQ" },
      {
        ...
        content: "NIE syllabi, past papers, marking schemes, exam-day checklist.",
      },
...
const SYLLABI: Row[] = [
  {
    title: "National Institute of Education (NIE) — syllabus portal",
    href: "https://nie.lk/",
    note: "The official source for every G.C.E. O/L syllabus. From the homepage open 'Curriculum' → 'Syllabi' to pick a subject and download the current-year PDF.",
  },
  {
    title: "e-thaksalawa — Ministry of Education subject portal",
    href: "https://e-thaksalawa.moe.gov.lk/",
    note: "Government e-learning portal. Every syllabus, teacher's guide, and textbook is filed here by grade and subject.",
  },
  {
    title: "Ministry of Education — Sri Lanka",
    href: "https://moe.gov.lk/",
    note: "Circulars, curriculum policy updates, and the official school calendar.",
  },
  {
    title: "Department of Examinations — main portal",
    href: "https://doenets.lk/",
    note: "Exam timetables, admission-card downloads, and result checking.",
  },
];
...
const PAST_PAPERS: Row[] = [
  ...
  {
    title: "e-thaksalawa — model & past papers",
    href: "https://e-thaksalawa.moe.gov.lk/",
    note: "Ministry-hosted archive of past papers, model papers, and marking schemes by year, subject, and medium.",
  },
  {
    title: "pastpapers.wiki — community archive",
    href: "https://pastpapers.wiki/",
    note: "Community-uploaded archive spanning ~15 years. Cross-check answers with the official marking scheme before trusting.",
  },
];

const EXAM_DAY: Row[] = [
  {
    title: "Two pens (blue), two pencils (2B), sharpener, eraser",
    href: "#",
    note: "You can't borrow inside the hall. Bring backups.",
  },
  {
    title: "Non-programmable scientific calculator",
    href: "#",
    note: "Check the memory is cleared. No graphing calculators.",
  },
  {
    title: "Ruler, protractor, geometry set",
    href: "#",
    note: "Geometry paper needs this — don't rely on freehand.",
  },
  {
    title: "Admission card + NIC / school ID",
    href: "#",
    note: "No card, no entry. Photocopy your card the night before.",
  },
  {
    title: "Water bottle (label removed) and a light snack",
    href: "#",
    note: "Papers are 2–3 hours. Hydration matters.",
  },
];
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-20">
        <header className="rise">
          ...
          <p className="mt-4 max-w-2xl text-base text-muted-foreground sm:text-lg">
            Official NIE syllabi, past-paper archives, marking schemes, and the exam-day checklist
            we wish someone had handed us. Everything free. Nothing gated.
          </p>
        </header>
